...
Revision ID: ee6b45c7331e
Revises: 
Create Date: 2022-10-06 18:14:11.294766
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('comprador', 'vendedor', 'admin', name='role'), nullable=False),
    ...
    sa.Column('type_service', sa.Enum('electricidad', 'plomeria', 'hogar', name='service_type'), nullable=False),
