...
Revision ID: 3aa7eaf3364e
Revises: 
Create Date: 2022-09-21 18:43:16.061657
...
def upgrade():
    ...
    sa.Column('cloudinary_id', sa.String(length=500), nullable=True),
    ...
    sa.Column('cloudinary_id_service', sa.String(length=500), nullable=True),
